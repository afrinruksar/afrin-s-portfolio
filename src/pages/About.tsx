        ...
        <motion.div className="md:col-span-1" variants={itemVariants}>
          <GlassCard glowOnHover>
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-2">Afrin Ruksar</h2>
              <p className="text-text-secondary mb-4">Front End Developer</p>
        ...
        <motion.div className="md:col-span-2" variants={itemVariants}>
          <GlassCard>
            ...
            <p className="text-text-secondary mb-4">
              I'm a passionate Front End Developer with over 1 years of experience in building web applications. I specialize in React, tailwind css, Javascript and I'm dedicated to creating clean, efficient, and user-friendly solutions.
            </p>
            <p className="text-text-secondary mb-4">
          ...
          <GlassCard glowOnHover className="h-full">
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                <p className="text-text-secondary">Kalyani Public School • 2020- 2022</p>
              </li>
              <li>
                <h4 className="font-semibold">X</h4>
                <p className="text-text-secondary">Auxilium Convent School • 2020</p>
              </li>
            </ul>
          </GlassCard>
        </motion.div>
